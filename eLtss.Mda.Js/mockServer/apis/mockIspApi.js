...
import {set, lodash, find} from 'lodash';

const IndividualSupportPlan2 = {
  "Redirect": null,
  "Message": null,
  "Partial": null,
  "Data": null,
  "DataObject": {
    "AttachedDocumentId": "individualsupportplans2/5ff3da32-adcd-4ce1-8e00-15f810c50a8a",
    "Attachments": [],
    "NewRevisedIspTypes": [
      {
        "Selected": false,
        "Text": "Change Request - Revision",
        "Value": "lookupitems/individualsupportplantypes/23502646-A882-4241-9482-541EB8387AF1"
      }, {
        "Selected": false,
        "Text": "Annual ISP - recertification",
        "Value": "lookupitems/individualsupportplantypes/8C932293-EF35-4E70-8DA8-540E6C4927C4"
      }
    ],
    ...
    "CurrentIdentity": {
      ...
      "Attributes": ["cae6b4a8-4ba4-457f-abe9-594d19aa8c28","9de2f010-bc0d-40d7-8c04-e38dfc10c6dc"],
      ...
      "Permissions": [
        "IndividualSupportPlanEdit",
        "IndividualSupportPlanProviderAdd",
        "IndividualSupportPlanProviderDelete",
        "IndividualSupportPlanEssentialInformationView",
        "IndividualSupportPlanPersonalProfileView",
        "IndividualSupportPlanPersonalProfileEdit",
        "IndividualSupportPlanSharedPlanningsView",
        "IndividualSupportPlanSharedPlanningsEdit",
        "IndividualSupportPlanPartDoesMyPlanMatchEdit",
        "IndividualSupportPlanPartTeamQuestionsEdit",
        "IndividualSupportPlanPartContributorsEdit",
        "IndividualSupportPlanPartPersonCenteredDatesEdit",
        "IndividualSupportPlanAddPlanForSupport",
        "IndividualSupportPlanPartDoesMyPlanMatchEdit",
        "IndividualSupportPlanPartTeamQuestionsEdit",
        "IndividualSupportPlanPartPersonCenteredDatesEdit",
        "IndividualSupportPlanAgreementSignaturesEdit",
        "IndividualSupportPlanAgreementView",
        "IndividualSupportPlanEssentialInformationEdit",
        "IndividualSupportPlanPart2Edit",
        "IndividualSupportPlanPart3Edit",
        "IndividualSupportPlanAttachmentUpload",
        "IndividualSupportPlanFormNoteEdit",
        "IndividualSupportPlanFormNoteView",
        "IndividualSupportPlanFormNoteCreate",
        "IndividualSupportPlanScComplete",
        "IndividualSupportPlanProviderComplete",
        "IndividualSupportPlanAddPlanForSupport"
      ]
    },
    "ClientId": "clients/88383187-18a4-4a76-adf0-3aa0b8734b19",
    "IndividualSupportPlan": {
      ...
      "Id": "individualsupportplans2/5ff3da32-adcd-4ce1-8e00-15f810c50a8a",
      "OriginalIndividualSupportPlanId": null,
      ...
      "IndividualSupportPlanType": {
        "Id": "lookupitems/individualsupportplantypes/F1EF4EA3-ED98-405B-A9DC-AF1D009A3F95",
        "Category": "individualsupportplantypes",
        "ParentId": null,
        "Abbreviation": null,
        "Name": "Enrollment - new ISP or initial",
        "Description": "Enrollment - new ISP or initial",
        "SortOrder": 101,
        "Inactive": false,
        "UniqueAttribute": {
          "Guid": "f1ef4ea3-ed98-405b-a9dc-af1d009a3f95",
          "Description": "Enrollment - new ISP or initial"
        },
        "RuleAttributes": [],
        "Stamp": null
    ...
    "IspTypes": [
      {
        "Selected": false,
        "Text": "Enrollment - new ISP or initial",
        "Value": "lookupitems/individualsupportplantypes/F1EF4EA3-ED98-405B-A9DC-AF1D009A3F95"
      }, {
        "Selected": false,
        "Text": "Change Request - Revision",
        "Value": "lookupitems/individualsupportplantypes/23502646-A882-4241-9482-541EB8387AF1"
  ...
  "DomainAuditTrails": [
    {
      ...
      "DocumentId": "individualsupportplans/04afb5b0-553d-468f-8f36-c19f726a633c",
...
const part5Summary = {
  "DataObject": {
    ...
    "PlanForSupport": {
      "Id": "part5s/-1",
      "IndividualSupportPlanId": "individualsupportplans/99d39bd8-2a01-43f3-8ca6-a70e947d23b7",
    ...
    "IspEffectiveDateRange": {
        "StartDate": "\/Date(1472995200000)\/",
        "EndDate": "\/Date(1499799900000)\/"
      }
  }
};
...
export function getPlanForSupportList() {
  return {DataObject: IndividualSupportPlan2.DataObject.IndividualSupportPlan.PlanForSupportList};
}
...
export function addSharedPlanning(sharedPlanningJson, completionStatusJson) {
  ...
  let result = set(IndividualSupportPlan2.DataObject.IndividualSupportPlan, 'CompletionStatus.SharedPlannings', overallStatus);
...
export function saveSectionObject(path, sectionJson, completionStatusJson) {
  ...
  let result = set(IndividualSupportPlan2.DataObject.IndividualSupportPlan, path, section);
  result = set(IndividualSupportPlan2.DataObject.IndividualSupportPlan, 'CompletionStatus', completionStatus);
  return result;
}
...
export function changePart5Section(path, sectionJson) {
  let result = set(part5Summary.DataObject, path, JSON.parse(sectionJson));
  return result;
}
...
export function addGeneralScheduleSupport(sectionJson, completionStatusJson) {
  ...
  let result = set(part5Summary.DataObject.PlanForSupport, 'CompletionStatus', completionStatus);
...
export function getServiceOutcomesSection() {
  let sos = {
    DataObject: {
      ...
      'IndividualSupportPlanId': part5Summary.DataObject.PlanForSupport.IndividualSupportPlanId,
...
export function createNewIspFormNote(payload) {
  ...
  let note={
    DataObject:{
      ...
      AccessableOrganizationUnitId:payload.accessableOuId
    },
    ResultFlag: 1,
    Message:"",
  };
...
export function getIndividualSupportPlan() {
  return Object.assign({}, IndividualSupportPlan2);
}
